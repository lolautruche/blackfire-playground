 ...
 *     $ ./vendor/bin/phpunit
 */
class DefaultControllerTest extends BlackfireTestCase
{
    ...
    protected const BLACKFIRE_SCENARIO_TITLE = 'Default Controller';
    ...
    {
        $blogPost = static::createClient()->getContainer()->get('doctrine')->getRepository(Post::class)->find(1);
        $client = static::createBlackfiredHttpBrowserClient();
